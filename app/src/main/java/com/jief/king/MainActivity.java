...
public class MainActivity extends InstrumentedActivity implements OnClickListener{
	...
	public static TextView Push_content;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Push_content = (TextView) findViewById(R.id.tv_push_content);

		Push_content.setText("设置");
		initView();
	...
	public static final String MESSAGE_RECEIVED_ACTION = "com.jief.king.MESSAGE_RECEIVED_ACTION";
